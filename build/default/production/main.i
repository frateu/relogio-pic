...
void relogio_click()
{
    ...
    PORTD=segmento[horaD]; ((PORTC) |= (1 << (0))); _delay((unsigned long)((5)*(20000000/4000.0))); ((PORTC) &= ~(1 << (0)));


    PORTD=segmento[horaU]; ((PORTC) |= (1 << (1))); ((PORTD) |= (1 << (7))); _delay((unsigned long)((5)*(20000000/4000.0))); ((PORTC) &= ~(1 << (1))); ((PORTD) &= ~(1 << (7)));


    PORTD=segmento[mintD]; ((PORTC) |= (1 << (2))); _delay((unsigned long)((5)*(20000000/4000.0))); ((PORTC) &= ~(1 << (2)));


    PORTD=segmento[mintU]; ((PORTC) |= (1 << (3))); ((PORTD) |= (1 << (7))); _delay((unsigned long)((5)*(20000000/4000.0))); ((PORTC) &= ~(1 << (3))); ((PORTD) &= ~(1 << (7)));


    PORTD=segmento[segdD]; ((PORTC) |= (1 << (4))); _delay((unsigned long)((5)*(20000000/4000.0))); ((PORTC) &= ~(1 << (4)));


    PORTD=segmento[segdU]; ((PORTC) |= (1 << (5))); _delay((unsigned long)((5)*(20000000/4000.0))); ((PORTC) &= ~(1 << (5)));
}
